...
class GCSDataLoader:
    ...
    def load_chunked_data(self, prefix: str = "data/processed/") -> List[Dict]:
        """
        Load chunked documents from GCS
        
        Args:
            prefix: GCS path prefix where your JSON files are stored
        ...
        # List all blobs (files) with the prefix
...
if __name__ == "__main__":
    # TODO: Replace with your actual bucket name and project ID
