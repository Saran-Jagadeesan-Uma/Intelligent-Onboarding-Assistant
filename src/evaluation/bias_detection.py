...
# ============================================================================
# SIMPLE BIAS DETECTOR WRAPPER FOR TEST COMPATIBILITY
# ============================================================================

class BiasDetector:
    """
    Simple wrapper around EnhancedBiasDetector for test compatibility.
    Provides a simplified interface matching test expectations.
    """
    
    def __init__(self, retriever, threshold: float = 0.15):
        """Initialize simple bias detector"""
        self.retriever = retriever
        self.threshold = threshold
    ...
    def generate_bias_report(self, test_queries: List[Dict], k: int = 5) -> Dict:
        """
        Generate a simple bias report for test queries.
        
        Args:
            test_queries: List of query dicts with 'query' and 'relevant_ids'
            k: Number of documents to retrieve
        ...
        # Simple bias check: high variance suggests inconsistency
        ...
        report = {
            ...
            'metrics': {
                'precision': 1.0 if not has_significant_bias else 0.8,  # Placeholder
